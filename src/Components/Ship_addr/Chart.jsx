    ...
    return(
        <>
            <div className="chart">
                ...
                <svg id="f" className="line" width="150" height="50"><path d="M 0 25 L 200 25"  stroke-width="2" /></svg>
                <div className="pay">
                ...
                <svg id="s" className="line" width="150" height="50"><path d="M 0 25 L 200 25"  stroke-width="2" /></svg>
                <div className="re">
